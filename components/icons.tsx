...
/**
 * Набор тонких линейных иконок (stroke 1.5) в едином стиле.
 * Используются в карточках услуг и блоке преимуществ.
 */
...
export function IconResearch(props: IconProps) {
  return (
    <svg {...base(props)}>
      ...
      <path d="M12 19v-9" />
      <path d="M16 19v-4" />
      <path d="m8 9 3-3 2 2 4-4" />
    </svg>
  );
}

export function IconPromotion(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="m3 11 18-6-6 18-3-7-9-5Z" />
      <path d="m12 12 3-1" />
    </svg>
  );
}
...
export function IconNetwork(props: IconProps) {
  return (
    <svg {...base(props)}>
      ...
      <path d="M7.6 7.8 10.6 15.6M16.4 7.8 13.4 15.6M8.5 6h7" />
    </svg>
  );
}
